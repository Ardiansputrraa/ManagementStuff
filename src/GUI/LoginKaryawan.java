...
public class LoginKaryawan implements InterfaceOptionPane {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (e.getSource() == loginJB) {
                        try {
                            ...
                            karyawan = new Karyawan(usernameJT.getText(), passJP.getText());
                            ...
                            String sql = "SELECT * FROM akun_karyawan WHERE username='" +
                                    karyawan.getUsername() + "' AND password='"
                            ...
                            if (res.next()) {
                                if (usernameJT.getText().equals(res.getString("username"))
                                    ...
                                    downKaryawan.setNama(res.getString("nama"));
                                    progresBar();
                                    ...
                                    int result = JOptionPane.showConfirmDialog(frame, "Apakah Anda Sudah Absensi?",
